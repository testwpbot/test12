/**
 * Movie Downloader Plugin with Buttons
 * Quality selection via buttons (1,2,3...) using reply handlers
 */
...
cmd({
  ...
  // Send **buttons** with numbers as IDs
  const buttons = downloadLinks.map((d,i) => ({
    id: `${i+1}`, // number ID for reply handler
