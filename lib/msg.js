...
const sms = (danuwa, m) => {
	...
	m.sendButtons = (data, options = {}) => sendButtons(danuwa, m.chat, data, { quoted: m, ...options })
	m.sendInteractive = (content, options = {}) => sendInteractive(danuwa, m.chat, content, { quoted: m, ...options })
	m.sendButtonMenu = (config, options = {}) => sendButtonMenu(danuwa, m.chat, config, { quoted: m, ...options })
