...
const CATEGORIES = {
  ...
  provincial: { label: 'Provincial paper', words: ['provincial', 'provinsial', 'province', 'palath', 'පළාත්', 'மாகாண'] }
};
const CAT_BY_WORD = {};
...
const TYPE_WORDS = {
  marking: ['marking', 'scheme', 'schema', 'answer', 'answers', 'uttara', 'උත්තර', 'விடை'],
  mcq: ['mcq'],
