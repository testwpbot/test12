...
async function aiInterpret(query, index) {
  ...
  const prompt =
    ...
    '{"action":"find","year":<number or null>,"subject":"<subject code or null>","medium":"<sinhala|english|tamil or null>"}\n' +
  ...
  try {
    ...
    const out = { action, year: null, subject: null, medium: null, keywords: '' };
    if (action === 'find') {
...
module.exports = {
  ...
  geminiReset, geminiKeys, aiInterpret
};
